...
class Auth
{
     ...
     * @return void
     */
    public static function remberRequestedPage()
    {
        $_SESSION['return_to'] = $_SERVER['REQUEST_URI'];
    }

    /**
     * Get the orginally-requested page to return to after requring login, or default to the homepage
     * 
     * @return void
     */
    ...
    protected static function loginFromRememberCookie()
    {
        ...
        if ($remembered_login && ! $remembered_login->hasExpierd()) {
    ...
    /**
     * Forget the temembered login, if present
     * 
     * @return void
     */
